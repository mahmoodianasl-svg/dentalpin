...
nuxt=lockver(fl,'nuxt'); devtools=lockver(fl,'@nuxt/devtools'); vite=lockver(fl,'vite'); types=lockver(fl,'@types/node')
...
if vt(vite) < (8,0,5): pending.append(f'frontend lock Vite is {vite}; target >=8.0.5 with Nuxt 4.5.1')
