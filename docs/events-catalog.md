...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:911`
- **Subscribers:**
  - `patient_timeline`
...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:848`
- **Subscribers:** —
...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:55`
- **Subscribers:**
  - `copilot`
  - `notifications`
  - `patient_timeline`
...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:52`
- **Subscribers:**
  - `patient_timeline`
...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:54`
- **Subscribers:**
  - `patient_timeline`
  - `recalls`
  - `treatment_plan`
...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:51`
- **Subscribers:**
  - `patient_timeline`
...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:53`
- **Subscribers:**
  - `patient_timeline`
...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:56`
- **Subscribers:**
  - `patient_timeline`
...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:551`
- **Subscribers:**
  - `notifications`
  - `patient_timeline`
  - `recalls`
...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:791`
- **Subscribers:** —
...
- **Publishers:**
  - `agenda` — `backend/app/modules/agenda/service.py:660`
- **Subscribers:**
  - `schedules`
...
- **Publishers:**
  - `patients` — `backend/app/modules/patients/service.py:335`
- **Subscribers:**
  - `media`
  - `periodontogram`
  - `recalls`
...
- **Publishers:**
  - `patients` — `backend/app/modules/patients/service.py:311`
- **Subscribers:** —
